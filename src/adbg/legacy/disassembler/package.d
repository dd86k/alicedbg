 ...
 */
module adbg.legacy.disassembler;

import adbg.error;
private import adbg.utils.strings;
private import adbg.legacy.debugger.exception : adbg_address_t;
private import adbg.legacy.disassembler.decoders;
public import adbg.legacy.disassembler.formatter;
...
int adbg_disasm_platform(adbg_disasm_t *disasm, AdbgPlatform m) {
	version (Trace) trace("disasm=%p platform=%d", disasm, m);
...
// alloc
deprecated("use adbg_disasm_init")
...
// configure
deprecated("use adbg_disasm_platform")
...
// set option
deprecated("use adbg_disasm_syntax")
...
int adbg_disasm(adbg_disasm_t *disasm, adbg_disasm_opcode_t *op) {
	version (Trace) trace("disasm=%p op=%p", disasm, op);
...
int adbg_disasm_fetch(T)(void *data, adbg_disasm_t *disasm, AdbgDisasmTag tag = AdbgDisasmTag.unknown) {
	...
	case buffer:
		...
		*cast(T*)data = *cast(T*)disasm.current;
		...
		break;
	case debugger:
		import adbg.legacy.debugger.debugger : adbg_mm_read;
